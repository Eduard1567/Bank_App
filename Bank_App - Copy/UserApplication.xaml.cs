...
public partial class UserApplication : ContentPage
{
	...
	{
        var result = await DisplayAlert("Delete account", "ARE YOU SURE YOU WANT TO DELETE YOUR ACCOUNT? Keep in mind that you can't recover your account later!", "Yes", "No");

        if (result)
		{
			ProgramCore.Users.DeleteAccount(user);
